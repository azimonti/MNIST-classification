...
./cbuild.sh --build-type "${BUILD_TYPE}" --cmake-params "-DCPP_LIBNN_BLAS=ON -DCPP_LIBCONFIG_LOADER=ON"

cd ../.. || exit
mkdir -p externals/ma-libs/build/mnist_classification/"${BUILD_TYPE}"
cd externals/ma-libs/build/mnist_classification || exit
